...
from ..datasets.loaders import BaseDataset, Sample
from ..patching import ActivationPatcher, ActivationCache
...
class ActivationPatchingExperiment(BaseExperiment):
    ...
    def run(
        ...
        **kwargs
        ...
        results = []
        layer_effects = {l: [] for l in layers}
        ...
        metrics["top_5_layers"] = [l for l, _ in sorted_layers[:5]]
