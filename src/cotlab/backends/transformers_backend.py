...
class TransformersBackend(InferenceBackend):
    ...
    def load_model(self, model_name: str, **kwargs) -> None:
        ...
        print(f"  Cache: ~/.cache/huggingface (HF default)")
    ...
    def generate_batch(
        ...
        **kwargs
        ...
        return [
            self.generate(prompt, max_new_tokens, temperature, **kwargs)
    ...
    def num_layers(self) -> int:
        ...
        return getattr(self._model.config, 'num_hidden_layers', None) or \
               getattr(self._model.config, 'num_layers', 0)
